...
Now that we have imported libraries, we start adding code inside fluidPage to create display elements. 'titlePanel' gives the heading, mainPanel creates the map using leaflet. We'll have user inputs in the sidebarPanel. We'll add those in later steps.
...
```
Now we create second tab for the predictive model integration in the app. We build radioButtons to choose between models. Price predictor 4 inputs to compute the price. Clicking on the actionButton price is predicted.
