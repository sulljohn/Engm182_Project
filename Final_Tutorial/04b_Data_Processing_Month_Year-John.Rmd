...
For analylsis, it is helpful to have the events grouped by month and year, then by a given zipcode. Then, a field like the crimescore can be aggregated an normalized for this criteria. In this case, the crime data is formatted in the desired way with the following command:
...
In addition, commands were run to normailze the crime score by the total popluation and only take data greater than the year 2000. There was extraneous data for crimes hundreds of years in the past and 2000 was chosen as a good baseline. It also appeared that the reporting method for these crimes changes in 2006, as evidenced by a dramatic change in the crime scores at this time.
