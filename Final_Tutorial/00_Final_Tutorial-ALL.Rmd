...
This section describes how we imported the data from each of our data sources into an R environment, where it can be then be easily cleaned and processed. The directory structure for our data files is pictured below:
```{r echo = FALSE}
