...
Download data from Google Drive / code from GitHub.

The following code reads the data in and gets unique values:
...
Our goal was to look at each county separately. The rest of this code divides it into separate datatframes:
