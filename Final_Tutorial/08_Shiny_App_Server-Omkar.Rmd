...
Now, we add a color palette. Using reverse geocoding, we map the reactive data based on the ZIP code as per the attribute chosen by the user on radioButton and time chosen on sliderInput. We also highlight the ZIP code areas for mouse hover.
