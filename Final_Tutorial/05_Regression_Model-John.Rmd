...
The desired independent and dependent (sale_price) variables are selecte with the code below and certain parameters are set to limit the amount of data.
...
The variables are coerced into the proper type for the regression (e.g. factor variable).
...
The data is partitioned into training and test sets for regression the data and determining the accuracy of a model on the test set respectively. For this initial regression analysis, a subset of 80% of the data is used for training and the rest is used for testing the accuracy of the predictions.
...
The results are summarized for analylsis.
...
The more detailed output from the regression model is summarized:
